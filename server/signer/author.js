...
function signupAuthor(fname, lname, uname, h_pwd, email, phone, coverphoto, userId, date, dualRole, isActive) {
...
function signinAuthor(uname,pwd) {
    ...
    async function getUserId (name){
        ...
        return(
            ...
            .then((pool) => 
                ...
                pool.query(`select "id" from "authors" where "uname" = '${name}'`)
        ...
        return(
            ...
            .then(async(pool) => {
                let database_return_value = await pool.query(
                    `select "uname", "pwd", "userId" from "authors" where "id" = '${id}'`
                )
